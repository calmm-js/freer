...
var Impure = /*#__PURE__*/(process.env.NODE_ENV === 'production' ? I.id : function (Impure) {
...
var handler = /*#__PURE__*/I.curry(function (onPure, onEffect) {
...
var Reader = function Reader() {
  ...
  var run$$1 = I.curryN(2, function (v) {
    return handler(of, function (e, k) {
      return e === ask ? k(v) : chain(k, e);
    });
  });
  var local = I.curry(function (vv, m) {
...
var State = function State() {
  ...
  var run$$1 = I.curry(function (s, m) {
    return runner(m, s);
  });
